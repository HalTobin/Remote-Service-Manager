...
import '../use_case/start_service_usecase.dart';
...
class ServiceManagerProvider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider(create: (context) => (StartServiceUseCase(sshService: context.read()))),
        Provider(create: (context) => (StopServiceUseCase(sshService: context.read()))),
        ...
        Provider(create: (context) => (
          ServiceManagerUseCases(
            ...
            startServiceUseCase: context.read(),
            stopServiceUseCase: context.read(),
